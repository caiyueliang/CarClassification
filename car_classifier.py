...
def parse_argvs():
    ...
    parser.add_argument("--output_model_path", type=str, help="output model path", default='./checkpoints/cc_resnet18_32.pkl')
    parser.add_argument('--classes_num', type=int, help='classes num', default=32)
