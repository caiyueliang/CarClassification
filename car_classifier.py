...
def parse_argvs():
    ...
    parser.add_argument('--old_classes_num', type=int, help='old classes num', default=21)
    parser.add_argument('--new_classes_num', type=int, help='new classes num', default=25)
