...
python car_classifier.py --model_name resnet18 --optimizer SGD --re_train False --lr 0.001
python car_classifier.py --model_name resnet34 --optimizer SGD --re_train False --lr 0.001